<?php 
  ...
  class Angriffs
  {
    ...
    public function getPKAngriff()
    {
      return $this->pk_angriff;
    }

    public function getFKMatchAngriff()
    {
      return $this->fk_match_angriff;
    }

    public function geFKPlayerAngriff()
    {
        return $this->fk_player_angriff;
    }
    public function getBalleErhalten()
    {
    ...
    public function getDruckvoll(){
        return $this->druckvoll;
    }

    public function getZuEasy(){
        return $this->zuEasy;
    }
    ...
    public function toXML()
    {
      ...
      $result = $result . '<fk_player_angriff>'.$this->geFKPlayerAngriff().'</fk_player_angriff>';
